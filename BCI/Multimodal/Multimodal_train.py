...
for epoch in range(Config.train_number_epochs):
    ...
    if (epoch + 1) % 2 == 0:
        save_path = f"/root/autodl-tmp/project/model_MA/5_model/5_model_epoch_{epoch + 1}.ph"
...
# 5) 保存模型
final_save_path = "/root/autodl-tmp/project/model_MA/5_model/5_model_final.ph"
torch.save(model.state_dict(), final_save_path)
print("最终模型已保存:", final_save_path)
