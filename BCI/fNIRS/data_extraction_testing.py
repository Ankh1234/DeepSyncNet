...
def extract2(file, index=0):
    ...
    for row in worksheet.iter_rows(values_only=True):
        # 提取前 36 列，确保值不为 None
        row_data = row[:36]
        if any(val is not None for val in row_data):  # 跳过全空行
...
for a in range(1,30):
    ...
    arr10 = arr10.reshape(60, -1)
        ...
        # print(label_extracted.shape)
        # print(data_extracted.shape)
        #if b == 1:
            #data_session1_extracted = data_extracted
            #label_session1_extracted = label_extracted
        #elif b == 3:
            #data_session3_extracted = data_extracted
            #label_session3_extracted = label_extracted
        #else:
            #data_session5_extracted = data_extracted
            #label_session5_extracted = label_extracted
    #data_sub_extracted = np.concatenate((data_session1_extracted, data_session3_extracted, data_session5_extracted),axis=0)
    #label_sub_extracted = np.concatenate((label_session1_extracted, label_session3_extracted, label_session5_extracted),axis=0)
    print(arr1.shape)
    print(label1.shape)
    # split_data = np.split(data_sub_extracted, 10)
    # split_label = np.split(label_sub_extracted, 10)
    #for d,arr1 in enumerate(split_data):
        #np.savetxt('/Users/lihao/Desktop/Open_Access_BCI_Data/EEG_data/testing_data/MI/sub0'+str(a)+'_test_data_0'+str(d)+'.csv', arr1, delimiter=',')

    #for e,arr2 in enumerate(split_label):
        #np.savetxt('/Users/lihao/Desktop/Open_Access_BCI_Data/EEG_data/testing_label/MI/sub0' + str(a) + '_test_label_0' + str(e) + '.csv', arr2, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_00.csv', arr1, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_00.csv', label1, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_01.csv',arr2, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_01.csv',label2, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_02.csv',arr3, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_02.csv',label3, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_03.csv',arr4, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_03.csv',label4, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_04.csv',arr5, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_04.csv',label5, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_05.csv',arr6, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_05.csv',label6, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_06.csv',arr7, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_06.csv',label7, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_07.csv',arr8, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_07.csv',label8, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_08.csv',arr9, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_08.csv',label9, delimiter='')

    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_data/MA/sub0' + str(a) + '_test_data_09.csv',arr10, delimiter=',')
    np.savetxt('/root/autodl-tmp/project/Open_Access_BCI_Data/fNIRS_data/testing_label/MA/sub0' + str(a) + '_test_label_09.csv',label10, delimiter='')